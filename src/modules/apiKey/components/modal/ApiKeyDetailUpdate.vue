<template>
  <div>
    <div class="form-row">
      ...
      <div>
        <b-input class="w-100" value="내용 노출"></b-input>
      </div>
    </div>
    ...
    <div class="form-row">
      <label>API KEY</label>
      <div>
        <b-input class="w-100" value="GW_TEST_1"></b-input>
      </div>
    </div>
    ...
    <div class="form-row">
      ...
      <div class="d-flex align-items-center">
        <b-input class="flex-fill"></b-input>
        <b-button variant="dark" class="ml-1">변경</b-button>
      </div>
    </div>
    ...
    <div class="form-row">
      <label>초당발송건수 TPS<br/>
        입력범위 0~100</label>
      <div>
        <b-input class="w-100" value="1,000"></b-input>
...
props: {
  ...
  data() {
    return {
      ...
      result: '사용',
      check: '프로젝트',
      ipArray:['100.99.*.*100.99.70.*49.170.27.3014.51.250.25100.99.72.*106.246.229.114164.124.106.143118.222.92.5164.124.106.146'],
    }
},
methods: {
  msgTooltip() {
