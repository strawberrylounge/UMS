<template>  
  <b-modal id="template-detail-modal" title="등록 템플릿 상세" hide-header-close size="xl" centered content-class="service-modal">
...
export default {
  ...
  methods: {
    closeModal() {
      this.$bvModal.hide('template-detail-modal');
    },
    setPageCount(value) {
