  ...
  <div class="landing-wrapper">
    ...
    <main id="landingMain" class="landing-main">
      ...
      <section class="section04">
        <div class="inner">
          <div class="title-area">
            ...
            <p class="pc">
              EC-톡톡에서 제공하는 다양한 서비스를 저렴한 요금으로 이용해보세요!
            </p>
            <p class="mb">
      ...
      <section class="section06">
        <figure>
          <img
            :src="require(`@/${PATHS.MAIN}section06-object.png`)"
...
export default {
  name: "Home",
  components: { Header, Footer, BtnTop, BtnInquiry },
  data() {
    return {
      PATHS,
    };
  ...
  section {
    ...
    &.section02 {
      ...
      &::after {
        ...
        width: 648px;
        height: 648px;
        background: url(v.$mainImg + "section02-object.png") right no-repeat;
        background-size: contain;
        @include v.tablet {
          top: 0;
          right: 0;
