...
import RCSPreview from '@/modules/ucRcsTemplateManageEdit/components/RCSPreview.vue'

export default {
  components: {
    IconQuestionLine, TemplateCard, IconArrowDown, TemplateTabs, 
    IconClose, IconPlus, RCSPreview,
  },
